...
public class SwissPfamParser {
    private static final String SWISSPFAM_FILEPATH = "/home/aut/Documents/Mental/Bioinformatics/project/data/Pfam/swisspfam";
    ...
    public static void main(String[] args) throws Exception {
        SwissPfamParser parser = new SwissPfamParser();
        parser.parse(SWISSPFAM_FILEPATH);
    }
    ...
    private void parse(String filePath) throws Exception {
        ...
        while (line != null) {
            ...
            if (startMatcher.find()) {
                ...
                if (proteinId != null) {
                    savePfamEntry(proteinId, proteinAccession, domains);
                }
    ...
    private void savePfamEntry(String proteinId, String proteinAccession, Map<Integer, String> domains) {
